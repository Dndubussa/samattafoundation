...
const Footer = () => {
  const socialLinks = [
    { icon: Facebook, href: "https://www.facebook.com/Samatta-Foundation", label: "Facebook" },
    { icon: Instagram, href: "https://www.instagram.com/samattafoundation?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==", label: "Instagram" },
    { icon: Youtube, href: "https://www.youtube.com/watch?v=Hlgu3_vQrF8", label: "YouTube" },
  ];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
          ...
          <div className="lg:col-span-1">
            <img
              ...
              className="h-20 w-auto mb-3 rounded-lg bg-primary-foreground p-2"
            />
