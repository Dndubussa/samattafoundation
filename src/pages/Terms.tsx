  ...
  return (
    <main className="pt-0">
      ...
      <section className="py-20 bg-background relative overflow-hidden">
        <div className="absolute top-20 right-0 w-96 h-96 bg-blue-400/10 rounded-full opacity-0" />
        <div className="absolute bottom-20 left-0 w-80 h-80 bg-sky-400/10 rounded-full opacity-0" />
